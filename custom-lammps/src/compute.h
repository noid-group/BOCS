...
//NJD 12/17/13 - These strings are to determine the CG-pressure correction basis function
//static const char ANALYTIC[] = "analytic";  
//static const char LINEAR_SPLINE[] = "linear_spline";
//static const char CUBIC_SPLINE[] = "cubic_spline";
...
class Compute : protected Pointers {
 public:
  ...
  //virtual double compute_cg_scalar() {return 0.0;} //NJD 8/21/13
  //virtual void compute_cg_vector() {} //NJD 10/17/13
  virtual void send_cg_info(int, int, double*, int, double) {} //NJD 10/17/13
  virtual void send_cg_info(int, std::vector< std::vector<double> >) {} //NJD 12/17/13
//  double get_cg_p_corr(std::vector< std::vector<double> >&, char *, double ); //NJD 12/18/13
